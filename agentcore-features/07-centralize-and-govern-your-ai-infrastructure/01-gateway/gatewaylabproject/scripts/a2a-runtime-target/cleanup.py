"""Clean up resources created by the a2a-runtime-target scripts.

The gateway is shared with the HTTP runtime-agent lab, so this script removes
...
CRED_PROVIDER_NAME = "a2a-runtime-obo"
