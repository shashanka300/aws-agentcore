...
Deletes the bedrock/openai/gemini inference targets, the Bedrock/OpenAI/Gemini
API key credential providers, the gateway, the gateway IAM role, and finally
...
GATEWAY_NAME = "model-governance-gateway"
API_KEY_PROVIDERS = [
    "governance-bedrock-key",
    "governance-openai-key",
    "governance-gemini-key",
]
